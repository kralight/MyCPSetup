...
function M.setup()
	...
	local highlight = {
		...
		CursorInsert = { fg=colors.black, bg=colors.light_white },
		CursorReplace = { fg=colors.black, bg=colors.light_white },
		...
		cConstant = { fg=colors.light_blue },
		String = { fg=colors.light_yellow },

		Keyword = { fg=colors.light_red, bold=true },
		Statement = { fg=colors.light_red, bold=true },
		Type = { fg=colors.dark_green, italic=true },
		PreProc = { fg=colors.dark_yellow },
		Operator = { fg=colors.light_white },
		Function = { fg=colors.light_cyan },

		cParen = { fg=colors.dark_yellow },
		cBracket = { fg=colors.dark_yellow },
		...
		Visual = { fg=colors.light_black, bg=colors.dark_green },
		MatchParen = { bg=colors.light_green },
